...
multiplicaCoeficientes([],_Cociente2,[]).
...
multiplicaPolinomios(_,[],[]). %No importa cual sea el primer polinomio, sino tiene con que multiplicar regresa una lista vacia. (CASO BASE 1)
